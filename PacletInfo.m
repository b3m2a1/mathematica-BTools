...
Paclet[Name -> "BTools", Version -> "1.0.33", Creator -> "b3m2a1@gmail.com", 
...
editing, etc.", Extensions -> {{"Kernel", "Root" -> ".", 
    "Context" -> {"BTools`"}, Root -> ".", Context -> {"BTools`"}}, 
   {"Resource", "Root" -> "Resources", "Resources" -> 
     {"Templates", "Themes"}}, {"FrontEnd", "Prepend" -> True}}, 
