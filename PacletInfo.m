...
Paclet[Name -> "BTools", Version -> "2.0.7", Creator -> "b3m2a1@gmail.com", 
...
editing, etc.", WolframVersion -> "10+", Internal -> False, Qualifier -> "", 
 ...
 Categories -> {"Development"}, Extensions -> 
  {{"Kernel", "Root" -> ".", "Context" -> {"BTools`"}, Root -> ".", 
   ...
   {"FrontEnd", "Prepend" -> True}}, Category -> "", Publisher -> "", 
 Support -> ""]
