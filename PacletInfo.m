...
Paclet[Name -> "BTools", Version -> "2.0.10", Creator -> "b3m2a1@gmail.com", 
...
editing, etc.", WolframVersion -> "10+", Internal -> False, 
 Loading -> "Manual", Qualifier -> "", SystemID -> All, BuildNumber -> "", 
 ...
 Categories -> {"Development"}, Extensions -> 
  {{"Kernel", "Root" -> ".", "Context" -> {"BTools`"}, Root -> ".", 
   ...
   {"FrontEnd", "Prepend" -> True}}, Category -> "", Enabled -> True, 
 Publisher -> "", Support -> ""]
