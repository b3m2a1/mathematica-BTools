...
If[Temp`PackageScope`BToolsLoading`Private`$DependencyLoad,
  Evaluate[Symbol["`BTools`PackageScope`Private`$RootContext"]]=$Context;
  BeginPackage["`BTools`"],
  Evaluate[Symbol["BTools`PackageScope`Private`$RootContext"]]="";
  BeginPackage["BTools`"]
  ]
...
BTools["Mode"]:=$PackageLoadingMode
$PackageLoadingMode=
...
BTools["Dependencies"]:=$PackageDependencies;
$PackageDependencies=
...
BTools["DependencyBase"]:=$PackageDependencyBase;
...
Remove["Temp`PackageScope`BToolsLoading`Private`*"]