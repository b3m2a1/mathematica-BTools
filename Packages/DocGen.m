...
RefPageSeeAlsoRefLink[_[s_String,l_String],cell:True|False:True]:=
	Cell[BoxData@
			TemplateBox[
				{
					Cell[TextData[Last@StringSplit[s,"`"]]],
...
RefPageGuideRefLink[_[s_String,g_String],cell:True|False:True]:=
	Cell[BoxData@
	...
	GenerateRefPages[doc,
		...
		FilterRules[{
			...
			"PostFunction"->
				(
					(
						SaveRefPages[#,dir,extension,ops];
						NotebookClose[#]
						)&
					)
			},
