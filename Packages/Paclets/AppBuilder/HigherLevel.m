...
AppAddDependency[
  ...
  Block[{
    ...
    Quiet@
      DeleteDirectory[FileNameJoin@{deppath, #}, DeleteContents->True]&/
        {"project", "Documentation", ".git", "Private"};
    Quiet@
      DeleteFile[FileNameJoin@{deppath, #}]&/
        {".gitignore"};
    newload=
      Merge[
        {
          Quiet@Replace[Import@AppPath[deppath, "Config", "LoadInfo.wl"],
            Except[_?OptionQ]->{}
            ],
          "Mode"->"Dependency"
          },
    ...
    AppRegenerateBuildInfo[deppath, 
      newload
      ];
    deppath
    ];
