...
builtPacletFileFind[
	...
	{f_String,v_String}
		...
		If[MatchQ[f,_PacletManager`Paclet],
			With[{
				info=
					Lookup[
...
PacletUpload[
	...
	Block[{
		...
		If[!AllTrue[files,MatchQ[_String?FileExistsQ]],
			Message[PacletUpload::nopac,Pick[Flatten@{pacletSpecs},MatchQ[None]/@files]]
			];
		pacletUpload[pacletSpecs,ops]/;AllTrue[files,MatchQ[_String?FileExistsQ]]
		];
Options[pacletUpload]=
	Options@PacletUpload;
pacletUpload[
