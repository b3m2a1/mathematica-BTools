...
SpelunkTrace::usage="Merges trace with spelunk";
									...
									pat->
										Graphics[{
											Replace[n,{
												...
												s_?(
													Function[Null,
														StringMatchQ[Context[#],"GeneralUtilities`"],
														HoldFirst
														]):>
													Sequence@@{
